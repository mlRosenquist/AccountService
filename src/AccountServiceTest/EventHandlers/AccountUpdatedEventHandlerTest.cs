...
public class AccountUpdatedEventHandlerTest
{
    private readonly AccountUpdatedEventHandler _uut;
    private readonly Mock<IAccountRepository> _accountRepositoryMock;
    
    private const int OpenAccountId = 1;
    private const int NonExistentAccountId = 2;
    
    public AccountUpdatedEventHandlerTest()
    {
        ...
        _uut = new AccountUpdatedEventHandler(loggerMock.Object, _accountRepositoryMock.Object);
    }
